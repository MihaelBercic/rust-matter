...
pub fn csa_asn() {
    ...
    assert_eq!(hex::encode(der_signature.clone()), "304402204308c3e5b86733243b1db4e930607b09a83d6e1beec7e0598e541c05f3d2b64602205479cd937810bb0f2311348984e6541ecc5c15661256ef93244f8b9b985fb04e");

    let sample = DerCertificationDeclaration {
        version: Int::new(&[3]).unwrap(),
        digest_algorithm: SetOf::try_from([DigestAlgorithmIdentifier {
            algorithm: "2.16.840.1.101.3.4.2.1".parse().unwrap(),
        }])
        .unwrap(),
        ...
        signer_info: SetOf::try_from([SignerInfo {
            version: Int::new(&[3]).unwrap(),
...
pub fn compute_certificate(product_id: u16, device_type: DeviceType, key: &[u8]) -> Vec<u8> {
    let input = CertificationDeclaration {
        format_version: 1,
        vendor_id: 0xFFF1,
        product_id: vec![product_id],
        device_type_id: 0x3e, //device_type as u32,
        certificate_id: "ZIG20142ZB330002-24".to_string(),
        security_level: 0,
        security_information: 0,
        version_number: 0x1,
        certification_type: 0,
...

 */
